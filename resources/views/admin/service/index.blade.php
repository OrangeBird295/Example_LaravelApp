                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset($row->service_image)}}" alt="" width="200px" height="200px">
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{url('/service/delete/'.$row->id)}}" class="btn btn-danger" onclick="return confirm('ต้องการลบหรือไม่ ?')">ลบข้อมูล</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
